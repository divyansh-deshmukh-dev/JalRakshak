...
export default function AdminMapClient({ currentLocation, wardLocations, onWardSelect, showSensors }: AdminMapClientProps) {
  ...
  return (
    <div className="h-[600px] w-full">
      ...
      >
        ...
        {showSensors && wardLocations.map((ward) => (
          <Marker
            key={ward.id}
            ...
            <Popup>
              <div className="p-2">
                ...
                <div className="text-xs space-y-1 mt-2">
                  ...
                  <div>Temperature: {ward.temp}°C</div>
                </div>
              </div>
            </Popup>
          </Marker>
