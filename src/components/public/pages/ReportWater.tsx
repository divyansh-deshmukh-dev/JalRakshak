...
import { Upload, Loader2, CheckCircle, AlertTriangle, Send, ClipboardList, Cpu } from 'lucide-react';
        ...
        <TabsContent value="my-reports">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View your submitted water quality reports</CardDescription>
            </CardHeader>
            <CardContent>
              {typeof window !== 'undefined' && localStorage.getItem('citizenLoggedIn') === 'true' ? (
                <MyReportsPage />
              ) : (
                <div className="text-center py-8">
                  <p className="text-muted-foreground mb-4">Please log in to view your reports</p>
                  <Button asChild>
        ...
        <TabsContent value="ai-insights">
          <Card>
            <CardHeader>
              ...
              <CardDescription>AI-powered analysis of water quality data</CardDescription>
            </CardHeader>
            <CardContent>
              {typeof window !== 'undefined' && localStorage.getItem('citizenLoggedIn') === 'true' ? (
                <AIInsightsPage />
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground mb-4">Please log in to view AI insights</p>
                  <Button asChild>
                    <a href="/citizen/login">Login</a>
                  </Button>
                </div>
